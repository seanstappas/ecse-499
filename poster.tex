...
\usepackage{float}                  % e.g. for DIN-A0 poster
...
\begin{columns}
	...
	\begin{column}{.35\textwidth}
		...
		\begin{figure}[!htb]
			\centering
			\includegraphics[width=0.5\columnwidth]{figures/es_uml.pdf}
			\caption
			{ES package.}
		\end{figure}
		...
		\begin{figure}[!htb]
			\centering
			\includegraphics[width=0.5\columnwidth]{figures/knn_uml.pdf}
			\caption
			{KNN package.}
		\end{figure}
		...
		\begin{figure}[!htb]
			\centering
			\includegraphics[width=0.5\columnwidth]{figures/knn_backward_think_1.png}
			\caption
			{Visualization of the KNN.}
		\end{figure}
