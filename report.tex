...
The \code{checkstyle} library enforces that the code conforms to a certain style. The style used for Prometheus is inspired from the Java Sun code style and is specified in the \code{checkstyle.xml} in the root directory.

Finally, the \code{FindBugs} library looks for common bugs in Java code. The full list of these bugs can be found on the library website.
